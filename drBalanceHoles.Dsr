VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drBalanceHoles 
   Bindings        =   "drBalanceHoles.dsx":0000
   Caption         =   "DataReport2"
   ClientHeight    =   5364
   ClientLeft      =   60
   ClientTop       =   348
   ...
   EndProperty
End
Attribute VB_Name = "drBalanceHoles"
